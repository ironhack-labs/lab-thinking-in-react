    ...
    render() {
        return (
            <div>
                ...
                <input type="checkbox" name="stocked" id="input2" checked={this.state.stocked} onChange={this.handleChange}/> <label htmlFor="input2">Only show products on stock</label>
            </div>
        )
    }
}
